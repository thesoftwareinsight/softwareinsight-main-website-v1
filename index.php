...
<html lang="en">
	<head>
        ...
        <meta name="title" content="The Software Insight - Full-services software development company">
        <meta name="description" content="We are full-service software development company that specializes in creating scalable and responsive solutions that are tailored to the client’s specific requirements. We specialize in creating innovative web and mobile applications that are fast, secure, scalable, and simple to operate for companies of all sizes, from start-ups to well-established corporations.
        ">
        ...
        <meta property="og:description" content="We are full-service software development company that specializes in creating scalable and responsive solutions that are tailored to the client’s specific requirements. We specialize in creating innovative web and mobile applications that are fast, secure, scalable, and simple to operate for companies of all sizes, from start-ups to well-established corporations.
        ">
        <meta property="og:image" content="">

        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="https://thesoftwareinsight.com/">
        <meta property="twitter:title" content="The Software Insight - Full-services software development company">
	...
	<body>
		<div class="main-page-wrapper light-bg">
				...
				<div class="inner-content">
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="right-widget d-flex align-items-center">
							...
							<a href="contactV2.html" class="tran3s contact-btn d-none d-sm-block">
					...
					<div class="row">
						<div class="col-xxl-5 col-xl-6 col-lg-7 ms-auto">
							<div class="text-wrapper pt-0">
								...
								<a href="about-usV1.html" class="theme-btn-one ripple-btn">More about us</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="feedback-section-three dark-bg mt-110 lg-mt-70">
				...
				<div class="inner-content d-lg-flex align-items-center clearfix">
					<div class="text-wrapper">
						...
						<a href="portfolioV1.html" class="theme-btn-three white-vr">View all case study <i class="fas fa-angle-right"></i></a>
					</div><!--  /.text-wrapper -->
						...
						<div class="feedback_slider_three">
							<div class="item">
								<div class="block-wrapper">
									<img src="images/media/img_05.jpg" alt="" class="screen">
							...
							<div class="item">
								<div class="block-wrapper">
									<img src="images/media/img_06.jpg" alt="" class="screen">
									<div class="overlay-content d-flex align-items-end">
										<a href="portfolio-detailsV2.html" class="d-flex justify-content-between align-items-center">
							...
							<div class="item">
								<div class="block-wrapper">
									<img src="images/media/img_07.jpg" alt="" class="screen">
									<div class="overlay-content d-flex align-items-end">
										<a href="portfolio-detailsV2.html" class="d-flex justify-content-between align-items-center">
			...
			<div class="feedback-section-four mt-130 lg-mt-80 sm-mt-40">
				<img src="images/shape/shape_09.svg" alt="" class="shapes shape-two">
				<img src="images/shape/shape_10.svg" alt="" class="shapes shape-three">
				<img src="images/shape/shape_11.svg" alt="" class="shapes shape-four">
				<div class="container">
							...
							<div class="partent-logos">
								<div class="row g-0">
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-6.png" alt="" class="tran3s"></a></div>
									</div>
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-7.png" alt="" class="tran3s"></a></div>
									</div>
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-8.png" alt="" class="tran3s"></a></div>
									</div>
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-9.png" alt="" class="tran3s"></a></div>
									</div>
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-10.png" alt="" class="tran3s"></a></div>
									</div>
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-11.png" alt="" class="tran3s"></a></div>
									</div>
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-12.png" alt="" class="tran3s"></a></div>
									</div>
									<div class="col-md-3 col-6">
										<div class="logo d-flex align-items-center justify-content-center"><a href="#"><img src="images/logo/logo-13.png" alt="" class="tran3s"></a></div>
									</div>
								</div>
							</div> <!-- /.partent-logos -->
						</div>
